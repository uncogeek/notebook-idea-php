!(function (t, n) {
    ...
    function n(t, n) {
        ...
        (t.prototype = Object.create(n && n.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), n && e(t, n);
    }
    function r(t) {
    ...
    var u = (function () {
            function n(t) {
                i(this, n),
                    ...
                    t.animation && ("boolean" == typeof t.animation || c(t.animation)) ? (this.animation = t.animation) : (this.animation = "fade"),
                    (this.port = null),
                ...
                s(n, [
                    {
                        ...
                        value: function () {
                            ...
                            return (
                                ...
                                (this.container = l("div", { class: "attention-component", style: t }, [l("div", { class: "inner" }, [l("div", { class: "content" }, [e, this.port])])])),
                                this.container
                            );
                        },
                    },
                ...
                s(e, [
                    {
                        ...
                        value: function () {
                            ...
                            if ((this.port.appendChild(n), this.useInnerHTML)) {
                                ...
                                (e.innerHTML = this.content), (t = l("div", { class: "inner-container xz" }, [e]));
                            } else t = l("div", { class: "inner-container xy" }, [l("p", { class: "content" }, [this.content])]);
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (this.useInnerHTML) {
                                ...
                                (o.innerHTML = this.content), (n = l("div", { class: "inner-container xc" }, [o, i]));
                            } else n = l("div", { class: "inner-container cv" }, [l("p", { class: "content" }, [this.content]), i]);
                ...
                s(e, [
                    {
                        ...
                        value: function () {
                            ...
                            if ((this.port.appendChild(e), this.useInnerHTML)) {
                                ...
                                (i.innerHTML = this.content), (t = l("div", { class: "inner-container xb" }, [i]));
                            } else t = l("div", { class: "inner-container xn" }, [l("p", { class: "content" }, [this.content])]);
                            t.appendChild(
                                l("div", { class: "buttons" }, [
                                    l(
                                        "button",
    ...
    (t.Alert = h), (t.Confirm = d), (t.Prompt = p), (t.version = "0.1.0"), Object.defineProperty(t, "__esModule", { value: !0 });
});
